...
imageManager.load({
	'aisle': 'img/three/aisle.png',
	'background': 'img/three/background.png',
	'ceil': 'img/three/ceil.png',
	'closet': 'img/three/closet.png',
	'desk': 'img/three/desk.png',
	'door': 'img/three/door.png',
	'light': 'img/three/light.png',
	'standing_area': 'img/three/standing_area.png',
	'wall': 'img/three/wall.png',
	'wall_low': 'img/three/wall_low.png'
}, function () {
	var srcList = [{label:'背景',data:imageManager.get('background')}, {label:'墙裙',data:imageManager.get('wall_low')}, {label:'柜子',data:imageManager.get('closet')}, {label:'门',data:imageManager.get('door')}, {label:'墙壁',data:imageManager.get('wall')}, {label:'走道',data:imageManager.get('aisle')}, {label:'凳子',data:imageManager.get('desk')}, {label:'站立区',data:imageManager.get('standing_area')}, {label:'灯',data:imageManager.get('light')}, {label:'顶',data:imageManager.get('ceil')}];
