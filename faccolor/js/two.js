...
imageManager.load({
	'wall': 'img/two/wall.png',
	'ceil': 'img/two/ceil.png',
	'door': 'img/two/door.png',
 	'door2': 'img/two/door2.png',
 	'door3': 'img/two/door3.png',
 	'floor': 'img/two/floor.png',
 	'floor2': 'img/two/floor2.png',
 	'floor3': 'img/two/floor3.png',
 	'gray': 'img/two/gray.png',
 	'red': 'img/two/red.png',
 	'yellow': 'img/two/yellow.png',
 	'ltyellow': 'img/two/ltyellow.png',
 	'handrail': 'img/two/handrail.png',
 	'background': 'img/two/background.png'
}, function () {
	var srcList = [{label:'背景',data:imageManager.get('background')}, {label:'门3',data:imageManager.get('door')}, {label:'门2',data:imageManager.get('door2')}, {label:'门1',data:imageManager.get('door3')}, {label:'灰',data:imageManager.get('gray')}, {label:'红',data:imageManager.get('red')}, {label:'浅黄',data:imageManager.get('ltyellow')}, {label:'黄',data:imageManager.get('yellow')}, {label:'地面-黄',data:imageManager.get('floor')}, {label:'地面-墨绿',data:imageManager.get('floor2')}, {label:'地面-蓝',data:imageManager.get('floor3')}, {label:'墙面',data:imageManager.get('wall')}, {label:'顶',data:imageManager.get('ceil')}, {label:'顶-栏杆',data:imageManager.get('handrail')}];
