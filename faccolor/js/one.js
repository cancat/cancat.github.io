...
imageManager.load({
	'wall': 'img/one/wall.png',
	'ceil': 'img/one/ceil.png',
	'door': 'img/one/door.png',
	'aisle': 'img/one/aisle.png',
	'aisle_p': 'img/one/aisle_p.png',
	'grocery': 'img/one/grocery.png',
	'fixed': 'img/one/fixed.png' 
}, function () {
	var srcList = [{label:'背景',data:imageManager.get('fixed')}, {label:'门',data:imageManager.get('door')}, {label:'人员通道',data:imageManager.get('aisle_p')}, {label:'货物堆放处',data:imageManager.get('grocery')}, {label:'货物通道',data:imageManager.get('aisle')}, {label:'墙',data:imageManager.get('wall')}, {label:'天花板',data:imageManager.get('ceil')}];
