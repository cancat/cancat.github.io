...
function handleTouch() {
	...
	return {
		...
		move: function (e) {
			speed = ((startX - e.targetTouches[0].pageX) / WIDTH) * 4 * 2;
			console.log(speed)
		    tl.timeScale(speed);
		    tl2.timeScale(speed);
		    tl3.timeScale(speed);
...
if (true) {
	document.addEventListener('touchstart', handleTouch().start, false);
	document.addEventListener('touchmove', handleTouch().move, false);
}
