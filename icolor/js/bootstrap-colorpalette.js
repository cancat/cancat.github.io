...
(function($) {
  ...
  var attachEvent = function(palette) {
    palette.element.on('click', function(e) {
      ...
      // welBtn.siblings().removeClass('current');
      // welBtn.parent().siblings().children().removeClass('current');
      $('.bootstrap-colorpalette .btn-color').removeClass('current');
      welBtn.addClass('current');
      palette.value = value;
